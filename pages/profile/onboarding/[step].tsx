  ...
  if (!currentFormPage) {
    return (
      <div className="w-full max-w-md mx-auto py-5">
        <div
          className="bg-white items-center justify-center shadow-md rounded px-8 pt-6 pb-8 mb-8"
  ...
  return (
    <div className="min-h-screen from-purple-50 bg-gradient-to-b pb-10 to-purple-200">
      <div className="w-full max-w-lg mx-auto py-5 px-4">
        ...
        <form
          className="bg-white shadow-xl rounded-lg px-6 sm:px-8 pt-6 pb-8 mb-8"
          onSubmit={handleSubmit(onSubmit)}
        >
          <div className="mb-8">
                ...
                <div key={index} className="mb-6 sm:mb-8">
                  ...
                  {block.fieldType === 'select' ? (
                    ...
                    <input
                      ...
                      autoFocus={index === 0}
                      {...register(block.fieldName, block.rules)}
                      className="shadow appearance-none border rounded w-full text-lg py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
