    ...
    <>
      <section className="px-4 pt-16 sm:px-6 lg:px-8">
        <div className="max-w-screen-xl mx-auto">
          <div className="pb-24 mx-auto prose prose-lg mt-14 sm:mt-16 lg:mt-24 sm:prose-xl">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Homies LLC,
                  Los Angeles, CA.
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Homies, accessible from
                  <a
                    href="https://www.meethomies.com"
                    rel="external nofollow noopener noreferrer"
                    target="_blank"
                  >
                    https://www.meethomies.com
                  </a>
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>
                <p>By email: hello@meethomies.com</p>
              </li>
              <li>
                <p>
                  By visiting this page on our website:{' '}
                  <Link href="/contact">
                    https://www.meethomies.com/contact
                  </Link>
                </p>
              </li>
              <li>
